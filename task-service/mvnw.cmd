...
if ($env:MVNW_USERNAME -and $env:MVNW_PASSWORD) {
  $MAVEN_HOME_NAME = ([System.Security.Cryptography.MD5]::Create().ComputeHash([System.Text.Encoding]::UTF8.GetBytes("$env:MVNW_USERNAME:$env:MVNW_PASSWORD@$distributionUrl")) | ForEach-Object {$_.ToString("x2")}) -join ''
} else {
